...
#'
#' A \code{\link[SummarizedExperiment:SummarizedExperiment-class]{SummarizedExperiment}} object containing DIA proteomics data from a UPS1-spiked E. coli proteins, processed using both Spectronaut and ScaffoldDIA separately, then merged, with the UPS1-spiked proteins subsequently removed.
#'
#' @name UPS1.Case2
#' @docType data
