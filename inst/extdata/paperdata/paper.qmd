...
library(parallel)
# Load the dataset
load("D:\\MJFF\\MJFF V2 10.30.2023\\proteogenomic study\\soma.rda")
print(soma)
...
# Set metadata and formula for LimROTS analysis
meta.info <- c("group_comp" , "gender" , "AGE") 
B <- 1000  # Number of bootstrap samples
...
saveRDS(limrots.result, "inst/extdata/paperdata/soma.LimROTS.rds")
```
