...
```{r}
plot(limrots.result2$q_values)
hist(limrots.result2$q_values)
hist(limrots.result2$q_values$qvalues)
hist(limrots.result2$FDR)
...
soma0.5 <- soma[, sample(1:524, 393) , drop = FALSE]
...
soma0.5@colData@listData[["CNO"]] <- paste0("CNO" , soma0.5@colData@listData[["CNO"]])

soma0.5@colData@listData[["CNO"]] <- as.factor(soma0.5@colData@listData[["CNO"]])
