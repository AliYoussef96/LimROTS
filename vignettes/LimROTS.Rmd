...
for Robust Differential Expression Analysis. *Bioinformatics*, btaf570. 
[https://doi.org/10.1093/bioinformatics/btaf570](https://doi.org/10.1093/bioinformatics/btaf570)

# Disclaimer

LimROTS is an independent implementation inspired by the limma and ROTS method. 
It is not affiliated with, endorsed by, or maintained by the original 
ROTS or limma development teams. This implementation was developed 
...
ROTS: Elo LL, Filén S, Lahesmaa R, Aittokallio T. Reproducibility-optimized 
test statistic for ranking genes in microarray studies. 
IEEE/ACM Transactions on Computational Biology and Bioinformatics. 
2008;5(3):423–31.

Users are advised to cite the original publications when referencing the 
ROTS or limma methods.
