...
```
NOTE: The target groups in the comparison should be factors 1 and 2. 
For example, here, "Conc." should have the factor levels "low" = 1 
and "high" = 2, so the "Conc." variable should be a factor.
