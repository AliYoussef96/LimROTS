...
rots.result <- ROTS(data = assay(UPS1.Case4), groups = groups, B = B, 
                    K = K, seed = 1234)
...
true_labels_limrots <- ifelse(row.names(limrots.result$data) %in% TP , 
                              TRUE, FALSE)
...
perfect scores of 1 in F1 score, balanced accuracy, positive and negative 
