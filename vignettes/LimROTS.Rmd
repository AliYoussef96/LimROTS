...
adjusted standard error $(SEpost = \sqrt{(s2.post)} * unscaled SD)$ for each feature
...
calculates the final statistics: $$t\_{\alpha(p)} = \frac{\beta_{(p)}}
{\alpha1 + \alpha2 \times SEpost_{(p)}}$$
